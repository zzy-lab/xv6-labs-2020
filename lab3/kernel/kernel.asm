...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ed6:	c6e080e7          	jalr	-914(ra) # 80005b40 <plicinithart>
  }
  ...
  scheduler();        
    ...
    80000f56:	bd8080e7          	jalr	-1064(ra) # 80005b2a <plicinit>
    plicinithart();  // ask PLIC for device interrupts
    80000f5a:	00005097          	auipc	ra,0x5
    80000f5e:	be6080e7          	jalr	-1050(ra) # 80005b40 <plicinithart>
    binit();         // buffer cache
    ...
    80000f7e:	ce8080e7          	jalr	-792(ra) # 80005c62 <virtio_disk_init>
    userinit();      // first user process
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800025ea:	48a78793          	addi	a5,a5,1162 # 80005a70 <kernelvec>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002712:	46a080e7          	jalr	1130(ra) # 80005b78 <plic_claim>
    ...
    80002740:	460080e7          	jalr	1120(ra) # 80005b9c <plic_complete>
    return 1;
    ...
    80002756:	92a080e7          	jalr	-1750(ra) # 8000607c <virtio_disk_intr>
...
000000008000277e <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80002798:	2dc78793          	addi	a5,a5,732 # 80005a70 <kernelvec>
...
bread(uint dev, uint blockno)
{
  ...
  return b;
    ...
    80002e98:	f12080e7          	jalr	-238(ra) # 80005da6 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002ec2:	ee8080e7          	jalr	-280(ra) # 80005da6 <virtio_disk_rw>
}
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    80004a28:	09505263          	blez	s5,80004aac <piperead+0xe8>
  ...
  for(i = 0; i < n; i++){  //DOC: piperead-copy
    ...
    80004aae:	b7d1                	j	80004a72 <piperead+0xae>

0000000080004ab0 <exec>:
...
{
    80004ab0:	df010113          	addi	sp,sp,-528
    80004ab4:	20113423          	sd	ra,520(sp)
    80004ab8:	20813023          	sd	s0,512(sp)
    80004abc:	ffa6                	sd	s1,504(sp)
    80004abe:	fbca                	sd	s2,496(sp)
    80004ac0:	f7ce                	sd	s3,488(sp)
    80004ac2:	f3d2                	sd	s4,480(sp)
    80004ac4:	efd6                	sd	s5,472(sp)
    80004ac6:	ebda                	sd	s6,464(sp)
    80004ac8:	e7de                	sd	s7,456(sp)
    80004aca:	e3e2                	sd	s8,448(sp)
    80004acc:	ff66                	sd	s9,440(sp)
    80004ace:	fb6a                	sd	s10,432(sp)
    80004ad0:	f76e                	sd	s11,424(sp)
    80004ad2:	0c00                	addi	s0,sp,528
    80004ad4:	84aa                	mv	s1,a0
    80004ad6:	dea43c23          	sd	a0,-520(s0)
    80004ada:	e0b43023          	sd	a1,-512(s0)
  ...
  struct proc *p = myproc();
    ...
    80004ae2:	eb6080e7          	jalr	-330(ra) # 80001994 <myproc>
    80004ae6:	892a                	mv	s2,a0

  begin_op();
    80004ae8:	fffff097          	auipc	ra,0xfffff
    80004aec:	49c080e7          	jalr	1180(ra) # 80003f84 <begin_op>

  if((ip = namei(path)) == 0){
    80004af0:	8526                	mv	a0,s1
    80004af2:	fffff097          	auipc	ra,0xfffff
    80004af6:	276080e7          	jalr	630(ra) # 80003d68 <namei>
    80004afa:	c92d                	beqz	a0,80004b6c <exec+0xbc>
  ...
  ilock(ip);
    ...
    80004b02:	ab4080e7          	jalr	-1356(ra) # 800035b2 <ilock>

  // Check ELF header
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    80004b06:	04000713          	li	a4,64
    80004b0a:	4681                	li	a3,0
    80004b0c:	e4840613          	addi	a2,s0,-440
    80004b10:	4581                	li	a1,0
    80004b12:	8526                	mv	a0,s1
    80004b14:	fffff097          	auipc	ra,0xfffff
    80004b18:	d52080e7          	jalr	-686(ra) # 80003866 <readi>
    80004b1c:	04000793          	li	a5,64
    80004b20:	00f51a63          	bne	a0,a5,80004b34 <exec+0x84>
    goto bad;
  if(elf.magic != ELF_MAGIC)
    80004b24:	e4842703          	lw	a4,-440(s0)
    80004b28:	464c47b7          	lui	a5,0x464c4
    80004b2c:	57f78793          	addi	a5,a5,1407 # 464c457f <_entry-0x39b3ba81>
    80004b30:	04f70463          	beq	a4,a5,80004b78 <exec+0xc8>
 ...
 bad:
  ...
  if(ip){
    ...
    80004b3a:	cde080e7          	jalr	-802(ra) # 80003814 <iunlockput>
    end_op();
    80004b3e:	fffff097          	auipc	ra,0xfffff
    80004b42:	4c6080e7          	jalr	1222(ra) # 80004004 <end_op>
  }
  return -1;
    80004b46:	557d                	li	a0,-1
}
    80004b48:	20813083          	ld	ra,520(sp)
    80004b4c:	20013403          	ld	s0,512(sp)
    80004b50:	74fe                	ld	s1,504(sp)
    80004b52:	795e                	ld	s2,496(sp)
    80004b54:	79be                	ld	s3,488(sp)
    80004b56:	7a1e                	ld	s4,480(sp)
    80004b58:	6afe                	ld	s5,472(sp)
    80004b5a:	6b5e                	ld	s6,464(sp)
    80004b5c:	6bbe                	ld	s7,456(sp)
    80004b5e:	6c1e                	ld	s8,448(sp)
    80004b60:	7cfa                	ld	s9,440(sp)
    80004b62:	7d5a                	ld	s10,432(sp)
    80004b64:	7dba                	ld	s11,424(sp)
    80004b66:	21010113          	addi	sp,sp,528
    80004b6a:	8082                	ret
    end_op();
    80004b6c:	fffff097          	auipc	ra,0xfffff
    80004b70:	498080e7          	jalr	1176(ra) # 80004004 <end_op>
    return -1;
    80004b74:	557d                	li	a0,-1
    80004b76:	bfc9                	j	80004b48 <exec+0x98>
  if((pagetable = proc_pagetable(p)) == 0)
    80004b78:	854a                	mv	a0,s2
    80004b7a:	ffffd097          	auipc	ra,0xffffd
    80004b7e:	ede080e7          	jalr	-290(ra) # 80001a58 <proc_pagetable>
    80004b82:	8baa                	mv	s7,a0
    80004b84:	d945                	beqz	a0,80004b34 <exec+0x84>
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004b86:	e6842983          	lw	s3,-408(s0)
    80004b8a:	e8045783          	lhu	a5,-384(s0)
    80004b8e:	c7ad                	beqz	a5,80004bf8 <exec+0x148>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    80004b90:	4901                	li	s2,0
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004b92:	4b01                	li	s6,0
    if(ph.vaddr % PGSIZE != 0)
    80004b94:	6c85                	lui	s9,0x1
    80004b96:	fffc8793          	addi	a5,s9,-1 # fff <_entry-0x7ffff001>
    80004b9a:	def43823          	sd	a5,-528(s0)
    80004b9e:	a42d                	j	80004dc8 <exec+0x318>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004ba4:	b1050513          	addi	a0,a0,-1264 # 800086b0 <syscalls+0x280>
    80004ba8:	ffffc097          	auipc	ra,0xffffc
    80004bac:	988080e7          	jalr	-1656(ra) # 80000530 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
    if(readi(ip, 0, (uint64)pa, offset+i, n) != n)
    80004bb0:	8756                	mv	a4,s5
    80004bb2:	012d86bb          	addw	a3,s11,s2
    80004bb6:	4581                	li	a1,0
    80004bb8:	8526                	mv	a0,s1
    80004bba:	fffff097          	auipc	ra,0xfffff
    80004bbe:	cac080e7          	jalr	-852(ra) # 80003866 <readi>
    80004bc2:	2501                	sext.w	a0,a0
    80004bc4:	1aaa9963          	bne	s5,a0,80004d76 <exec+0x2c6>
  for(i = 0; i < sz; i += PGSIZE){
    80004bc8:	6785                	lui	a5,0x1
    80004bca:	0127893b          	addw	s2,a5,s2
    80004bce:	77fd                	lui	a5,0xfffff
    80004bd0:	01478a3b          	addw	s4,a5,s4
    80004bd4:	1f897163          	bgeu	s2,s8,80004db6 <exec+0x306>
    pa = walkaddr(pagetable, va + i);
    80004bd8:	02091593          	slli	a1,s2,0x20
    80004bdc:	9181                	srli	a1,a1,0x20
    80004bde:	95ea                	add	a1,a1,s10
    80004be0:	855e                	mv	a0,s7
    80004be2:	ffffc097          	auipc	ra,0xffffc
    80004be6:	482080e7          	jalr	1154(ra) # 80001064 <walkaddr>
    80004bea:	862a                	mv	a2,a0
    if(pa == 0)
    80004bec:	d955                	beqz	a0,80004ba0 <exec+0xf0>
      n = PGSIZE;
    80004bee:	8ae6                	mv	s5,s9
    if(sz - i < PGSIZE)
    80004bf0:	fd9a70e3          	bgeu	s4,s9,80004bb0 <exec+0x100>
      n = sz - i;
    80004bf4:	8ad2                	mv	s5,s4
    80004bf6:	bf6d                	j	80004bb0 <exec+0x100>
  uint64 argc, sz = 0, sp, ustack[MAXARG+1], stackbase;
    80004bf8:	4901                	li	s2,0
  iunlockput(ip);
    80004bfa:	8526                	mv	a0,s1
    80004bfc:	fffff097          	auipc	ra,0xfffff
    80004c00:	c18080e7          	jalr	-1000(ra) # 80003814 <iunlockput>
  end_op();
    80004c04:	fffff097          	auipc	ra,0xfffff
    80004c08:	400080e7          	jalr	1024(ra) # 80004004 <end_op>
  p = myproc();
    80004c0c:	ffffd097          	auipc	ra,0xffffd
    80004c10:	d88080e7          	jalr	-632(ra) # 80001994 <myproc>
    80004c14:	8aaa                	mv	s5,a0
  uint64 oldsz = p->sz;
    80004c16:	04853d03          	ld	s10,72(a0)
  sz = PGROUNDUP(sz);
    80004c1a:	6785                	lui	a5,0x1
    80004c1c:	17fd                	addi	a5,a5,-1
    80004c1e:	993e                	add	s2,s2,a5
    80004c20:	757d                	lui	a0,0xfffff
    80004c22:	00a977b3          	and	a5,s2,a0
    80004c26:	e0f43423          	sd	a5,-504(s0)
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    80004c2a:	6609                	lui	a2,0x2
    80004c2c:	963e                	add	a2,a2,a5
    80004c2e:	85be                	mv	a1,a5
    80004c30:	855e                	mv	a0,s7
    80004c32:	ffffc097          	auipc	ra,0xffffc
    80004c36:	7d4080e7          	jalr	2004(ra) # 80001406 <uvmalloc>
    80004c3a:	8b2a                	mv	s6,a0
  ip = 0;
    80004c3c:	4481                	li	s1,0
  if((sz1 = uvmalloc(pagetable, sz, sz + 2*PGSIZE)) == 0)
    80004c3e:	12050c63          	beqz	a0,80004d76 <exec+0x2c6>
  uvmclear(pagetable, sz-2*PGSIZE);
    80004c42:	75f9                	lui	a1,0xffffe
    80004c44:	95aa                	add	a1,a1,a0
    80004c46:	855e                	mv	a0,s7
    80004c48:	ffffd097          	auipc	ra,0xffffd
    80004c4c:	9dc080e7          	jalr	-1572(ra) # 80001624 <uvmclear>
  stackbase = sp - PGSIZE;
    80004c50:	7c7d                	lui	s8,0xfffff
    80004c52:	9c5a                	add	s8,s8,s6
  for(argc = 0; argv[argc]; argc++) {
    80004c54:	e0043783          	ld	a5,-512(s0)
    80004c58:	6388                	ld	a0,0(a5)
    80004c5a:	c535                	beqz	a0,80004cc6 <exec+0x216>
    80004c5c:	e8840993          	addi	s3,s0,-376
    80004c60:	f8840c93          	addi	s9,s0,-120
  sp = sz;
    80004c64:	895a                	mv	s2,s6
    sp -= strlen(argv[argc]) + 1;
    80004c66:	ffffc097          	auipc	ra,0xffffc
    80004c6a:	1f4080e7          	jalr	500(ra) # 80000e5a <strlen>
    80004c6e:	2505                	addiw	a0,a0,1
    80004c70:	40a90933          	sub	s2,s2,a0
    sp -= sp % 16; // riscv sp must be 16-byte aligned
    80004c74:	ff097913          	andi	s2,s2,-16
    if(sp < stackbase)
    80004c78:	13896363          	bltu	s2,s8,80004d9e <exec+0x2ee>
    if(copyout(pagetable, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
    80004c7c:	e0043d83          	ld	s11,-512(s0)
    80004c80:	000dba03          	ld	s4,0(s11)
    80004c84:	8552                	mv	a0,s4
    80004c86:	ffffc097          	auipc	ra,0xffffc
    80004c8a:	1d4080e7          	jalr	468(ra) # 80000e5a <strlen>
    80004c8e:	0015069b          	addiw	a3,a0,1
    80004c92:	8652                	mv	a2,s4
    80004c94:	85ca                	mv	a1,s2
    80004c96:	855e                	mv	a0,s7
    80004c98:	ffffd097          	auipc	ra,0xffffd
    80004c9c:	9be080e7          	jalr	-1602(ra) # 80001656 <copyout>
    80004ca0:	10054363          	bltz	a0,80004da6 <exec+0x2f6>
    ustack[argc] = sp;
    80004ca4:	0129b023          	sd	s2,0(s3)
  for(argc = 0; argv[argc]; argc++) {
    80004ca8:	0485                	addi	s1,s1,1
    80004caa:	008d8793          	addi	a5,s11,8
    80004cae:	e0f43023          	sd	a5,-512(s0)
    80004cb2:	008db503          	ld	a0,8(s11)
    80004cb6:	c911                	beqz	a0,80004cca <exec+0x21a>
    if(argc >= MAXARG)
    80004cb8:	09a1                	addi	s3,s3,8
    80004cba:	fb3c96e3          	bne	s9,s3,80004c66 <exec+0x1b6>
  sz = sz1;
    80004cbe:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80004cc2:	4481                	li	s1,0
    80004cc4:	a84d                	j	80004d76 <exec+0x2c6>
  sp = sz;
    80004cc6:	895a                	mv	s2,s6
  for(argc = 0; argv[argc]; argc++) {
    80004cc8:	4481                	li	s1,0
  ustack[argc] = 0;
    80004cca:	00349793          	slli	a5,s1,0x3
    80004cce:	f9040713          	addi	a4,s0,-112
    80004cd2:	97ba                	add	a5,a5,a4
    80004cd4:	ee07bc23          	sd	zero,-264(a5) # ef8 <_entry-0x7ffff108>
  ...
  if(sp < stackbase)
    80004ce6:	01897663          	bgeu	s2,s8,80004cf2 <exec+0x242>
  sz = sz1;
    80004cea:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80004cee:	4481                	li	s1,0
    80004cf0:	a059                	j	80004d76 <exec+0x2c6>
  if(copyout(pagetable, sp, (char *)ustack, (argc+1)*sizeof(uint64)) < 0)
    80004cf2:	e8840613          	addi	a2,s0,-376
    80004cf6:	85ca                	mv	a1,s2
    80004cf8:	855e                	mv	a0,s7
    80004cfa:	ffffd097          	auipc	ra,0xffffd
    80004cfe:	95c080e7          	jalr	-1700(ra) # 80001656 <copyout>
    80004d02:	0a054663          	bltz	a0,80004dae <exec+0x2fe>
  p->trapframe->a1 = sp;
    80004d06:	058ab783          	ld	a5,88(s5)
    80004d0a:	0727bc23          	sd	s2,120(a5)
  for(last=s=path; *s; s++)
    80004d0e:	df843783          	ld	a5,-520(s0)
    80004d12:	0007c703          	lbu	a4,0(a5)
    80004d16:	cf11                	beqz	a4,80004d32 <exec+0x282>
    80004d18:	0785                	addi	a5,a5,1
    if(*s == '/')
    80004d1a:	02f00693          	li	a3,47
    80004d1e:	a029                	j	80004d28 <exec+0x278>
  for(last=s=path; *s; s++)
    80004d20:	0785                	addi	a5,a5,1
    80004d22:	fff7c703          	lbu	a4,-1(a5)
    80004d26:	c711                	beqz	a4,80004d32 <exec+0x282>
    if(*s == '/')
    80004d28:	fed71ce3          	bne	a4,a3,80004d20 <exec+0x270>
      last = s+1;
    80004d2c:	def43c23          	sd	a5,-520(s0)
    80004d30:	bfc5                	j	80004d20 <exec+0x270>
  safestrcpy(p->name, last, sizeof(p->name));
    80004d32:	4641                	li	a2,16
    80004d34:	df843583          	ld	a1,-520(s0)
    80004d38:	158a8513          	addi	a0,s5,344
    80004d3c:	ffffc097          	auipc	ra,0xffffc
    80004d40:	0ec080e7          	jalr	236(ra) # 80000e28 <safestrcpy>
  oldpagetable = p->pagetable;
    80004d44:	050ab503          	ld	a0,80(s5)
  p->pagetable = pagetable;
    80004d48:	057ab823          	sd	s7,80(s5)
  p->sz = sz;
    80004d4c:	056ab423          	sd	s6,72(s5)
  p->trapframe->epc = elf.entry;  // initial program counter = main
    80004d50:	058ab783          	ld	a5,88(s5)
    80004d54:	e6043703          	ld	a4,-416(s0)
    80004d58:	ef98                	sd	a4,24(a5)
  p->trapframe->sp = sp; // initial stack pointer
    80004d5a:	058ab783          	ld	a5,88(s5)
    80004d5e:	0327b823          	sd	s2,48(a5)
  proc_freepagetable(oldpagetable, oldsz);
    80004d62:	85ea                	mv	a1,s10
    80004d64:	ffffd097          	auipc	ra,0xffffd
    80004d68:	d90080e7          	jalr	-624(ra) # 80001af4 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    80004d6c:	0004851b          	sext.w	a0,s1
    80004d70:	bbe1                	j	80004b48 <exec+0x98>
    80004d72:	e1243423          	sd	s2,-504(s0)
    proc_freepagetable(pagetable, sz);
    80004d76:	e0843583          	ld	a1,-504(s0)
    80004d7a:	855e                	mv	a0,s7
    80004d7c:	ffffd097          	auipc	ra,0xffffd
    80004d80:	d78080e7          	jalr	-648(ra) # 80001af4 <proc_freepagetable>
  if(ip){
    80004d84:	da0498e3          	bnez	s1,80004b34 <exec+0x84>
  return -1;
    80004d88:	557d                	li	a0,-1
    80004d8a:	bb7d                	j	80004b48 <exec+0x98>
    80004d8c:	e1243423          	sd	s2,-504(s0)
    80004d90:	b7dd                	j	80004d76 <exec+0x2c6>
    80004d92:	e1243423          	sd	s2,-504(s0)
    80004d96:	b7c5                	j	80004d76 <exec+0x2c6>
    80004d98:	e1243423          	sd	s2,-504(s0)
    80004d9c:	bfe9                	j	80004d76 <exec+0x2c6>
  sz = sz1;
    80004d9e:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80004da2:	4481                	li	s1,0
    80004da4:	bfc9                	j	80004d76 <exec+0x2c6>
  sz = sz1;
    80004da6:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80004daa:	4481                	li	s1,0
    80004dac:	b7e9                	j	80004d76 <exec+0x2c6>
  sz = sz1;
    80004dae:	e1643423          	sd	s6,-504(s0)
  ip = 0;
    80004db2:	4481                	li	s1,0
    80004db4:	b7c9                	j	80004d76 <exec+0x2c6>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    80004db6:	e0843903          	ld	s2,-504(s0)
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    80004dba:	2b05                	addiw	s6,s6,1
    80004dbc:	0389899b          	addiw	s3,s3,56
    80004dc0:	e8045783          	lhu	a5,-384(s0)
    80004dc4:	e2fb5be3          	bge	s6,a5,80004bfa <exec+0x14a>
    if(readi(ip, 0, (uint64)&ph, off, sizeof(ph)) != sizeof(ph))
    80004dc8:	2981                	sext.w	s3,s3
    80004dca:	03800713          	li	a4,56
    80004dce:	86ce                	mv	a3,s3
    80004dd0:	e1040613          	addi	a2,s0,-496
    80004dd4:	4581                	li	a1,0
    80004dd6:	8526                	mv	a0,s1
    80004dd8:	fffff097          	auipc	ra,0xfffff
    80004ddc:	a8e080e7          	jalr	-1394(ra) # 80003866 <readi>
    80004de0:	03800793          	li	a5,56
    80004de4:	f8f517e3          	bne	a0,a5,80004d72 <exec+0x2c2>
    if(ph.type != ELF_PROG_LOAD)
    80004de8:	e1042783          	lw	a5,-496(s0)
    80004dec:	4705                	li	a4,1
    80004dee:	fce796e3          	bne	a5,a4,80004dba <exec+0x30a>
    if(ph.memsz < ph.filesz)
    80004df2:	e3843603          	ld	a2,-456(s0)
    80004df6:	e3043783          	ld	a5,-464(s0)
    80004dfa:	f8f669e3          	bltu	a2,a5,80004d8c <exec+0x2dc>
    if(ph.vaddr + ph.memsz < ph.vaddr)
    80004dfe:	e2043783          	ld	a5,-480(s0)
    80004e02:	963e                	add	a2,a2,a5
    80004e04:	f8f667e3          	bltu	a2,a5,80004d92 <exec+0x2e2>
    if((sz1 = uvmalloc(pagetable, sz, ph.vaddr + ph.memsz)) == 0)
    80004e08:	85ca                	mv	a1,s2
    80004e0a:	855e                	mv	a0,s7
    80004e0c:	ffffc097          	auipc	ra,0xffffc
    80004e10:	5fa080e7          	jalr	1530(ra) # 80001406 <uvmalloc>
    80004e14:	e0a43423          	sd	a0,-504(s0)
    80004e18:	d141                	beqz	a0,80004d98 <exec+0x2e8>
    if(ph.vaddr % PGSIZE != 0)
    80004e1a:	e2043d03          	ld	s10,-480(s0)
    80004e1e:	df043783          	ld	a5,-528(s0)
    80004e22:	00fd77b3          	and	a5,s10,a5
    80004e26:	fba1                	bnez	a5,80004d76 <exec+0x2c6>
    if(loadseg(pagetable, ph.vaddr, ip, ph.off, ph.filesz) < 0)
    80004e28:	e1842d83          	lw	s11,-488(s0)
    80004e2c:	e3042c03          	lw	s8,-464(s0)
  for(i = 0; i < sz; i += PGSIZE){
    80004e30:	f80c03e3          	beqz	s8,80004db6 <exec+0x306>
    80004e34:	8a62                	mv	s4,s8
    80004e36:	4901                	li	s2,0
    80004e38:	b345                	j	80004bd8 <exec+0x128>

0000000080004e3a <argfd>:
...
argfd(int n, int *pfd, struct file **pf)
{
    ...
    80004e40:	ec26                	sd	s1,24(sp)
    80004e42:	e84a                	sd	s2,16(sp)
    80004e44:	1800                	addi	s0,sp,48
    80004e46:	892e                	mv	s2,a1
    80004e48:	84b2                	mv	s1,a2
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
    80004e4a:	fdc40593          	addi	a1,s0,-36
    80004e4e:	ffffe097          	auipc	ra,0xffffe
    80004e52:	bf2080e7          	jalr	-1038(ra) # 80002a40 <argint>
    80004e56:	04054063          	bltz	a0,80004e96 <argfd+0x5c>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    80004e5a:	fdc42703          	lw	a4,-36(s0)
    80004e5e:	47bd                	li	a5,15
    80004e60:	02e7ed63          	bltu	a5,a4,80004e9a <argfd+0x60>
    80004e64:	ffffd097          	auipc	ra,0xffffd
    80004e68:	b30080e7          	jalr	-1232(ra) # 80001994 <myproc>
    80004e6c:	fdc42703          	lw	a4,-36(s0)
    80004e70:	01a70793          	addi	a5,a4,26
    80004e74:	078e                	slli	a5,a5,0x3
    80004e76:	953e                	add	a0,a0,a5
    80004e78:	611c                	ld	a5,0(a0)
    80004e7a:	c395                	beqz	a5,80004e9e <argfd+0x64>
    return -1;
  if(pfd)
    80004e7c:	00090463          	beqz	s2,80004e84 <argfd+0x4a>
    *pfd = fd;
  ...
  if(pf)
    80004e86:	c091                	beqz	s1,80004e8a <argfd+0x50>
    *pf = f;
    ...
    80004e98:	bfcd                	j	80004e8a <argfd+0x50>
    return -1;
    80004e9a:	557d                	li	a0,-1
    80004e9c:	b7fd                	j	80004e8a <argfd+0x50>
    80004e9e:	557d                	li	a0,-1
    80004ea0:	b7ed                	j	80004e8a <argfd+0x50>

0000000080004ea2 <fdalloc>:
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80004eb2:	ae6080e7          	jalr	-1306(ra) # 80001994 <myproc>
    80004eb6:	862a                	mv	a2,a0

  for(fd = 0; fd < NOFILE; fd++){
    80004eb8:	0d050793          	addi	a5,a0,208 # fffffffffffff0d0 <end+0xffffffff7ffd90d0>
    80004ebc:	4501                	li	a0,0
    80004ebe:	46c1                	li	a3,16
    if(p->ofile[fd] == 0){
    80004ec0:	6398                	ld	a4,0(a5)
    80004ec2:	cb19                	beqz	a4,80004ed8 <fdalloc+0x36>
  for(fd = 0; fd < NOFILE; fd++){
    80004ec4:	2505                	addiw	a0,a0,1
    80004ec6:	07a1                	addi	a5,a5,8
    80004ec8:	fed51ce3          	bne	a0,a3,80004ec0 <fdalloc+0x1e>
      p->ofile[fd] = f;
      return fd;
    }
  }
  return -1;
    ...
    80004ed6:	8082                	ret
      p->ofile[fd] = f;
    80004ed8:	01a50793          	addi	a5,a0,26
    80004edc:	078e                	slli	a5,a5,0x3
    80004ede:	963e                	add	a2,a2,a5
    80004ee0:	e204                	sd	s1,0(a2)
      return fd;
    80004ee2:	b7f5                	j	80004ece <fdalloc+0x2c>

0000000080004ee4 <create>:
  return -1;
}
...
create(char *path, short type, short major, short minor)
{
    ...
    80004ef4:	0880                	addi	s0,sp,80
    80004ef6:	89ae                	mv	s3,a1
    80004ef8:	8ab2                	mv	s5,a2
    80004efa:	8a36                	mv	s4,a3
  struct inode *ip, *dp;
  char name[DIRSIZ];
  ...
  if((dp = nameiparent(path, name)) == 0)
    ...
    80004f04:	e86080e7          	jalr	-378(ra) # 80003d86 <nameiparent>
    80004f08:	892a                	mv	s2,a0
    80004f0a:	12050f63          	beqz	a0,80005048 <create+0x164>
    return 0;

  ilock(dp);
    80004f0e:	ffffe097          	auipc	ra,0xffffe
    80004f12:	6a4080e7          	jalr	1700(ra) # 800035b2 <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    80004f22:	b78080e7          	jalr	-1160(ra) # 80003a96 <dirlookup>
    80004f26:	84aa                	mv	s1,a0
    80004f28:	c921                	beqz	a0,80004f78 <create+0x94>
    iunlockput(dp);
    80004f2a:	854a                	mv	a0,s2
    80004f2c:	fffff097          	auipc	ra,0xfffff
    80004f30:	8e8080e7          	jalr	-1816(ra) # 80003814 <iunlockput>
    ilock(ip);
    80004f34:	8526                	mv	a0,s1
    80004f36:	ffffe097          	auipc	ra,0xffffe
    80004f3a:	67c080e7          	jalr	1660(ra) # 800035b2 <ilock>
    if(type == T_FILE && (ip->type == T_FILE || ip->type == T_DEVICE))
    80004f3e:	2981                	sext.w	s3,s3
    80004f40:	4789                	li	a5,2
    80004f42:	02f99463          	bne	s3,a5,80004f6a <create+0x86>
    80004f46:	0444d783          	lhu	a5,68(s1)
    80004f4a:	37f9                	addiw	a5,a5,-2
    80004f4c:	17c2                	slli	a5,a5,0x30
    80004f4e:	93c1                	srli	a5,a5,0x30
    80004f50:	4705                	li	a4,1
    80004f52:	00f76c63          	bltu	a4,a5,80004f6a <create+0x86>
  ...
  return ip;
    ...
    80004f66:	6161                	addi	sp,sp,80
    80004f68:	8082                	ret
    iunlockput(ip);
    80004f6a:	8526                	mv	a0,s1
    80004f6c:	fffff097          	auipc	ra,0xfffff
    80004f70:	8a8080e7          	jalr	-1880(ra) # 80003814 <iunlockput>
    return 0;
    80004f74:	4481                	li	s1,0
    80004f76:	b7c5                	j	80004f56 <create+0x72>
  if((ip = ialloc(dp->dev, type)) == 0)
    80004f78:	85ce                	mv	a1,s3
    80004f7a:	00092503          	lw	a0,0(s2)
    80004f7e:	ffffe097          	auipc	ra,0xffffe
    80004f82:	49c080e7          	jalr	1180(ra) # 8000341a <ialloc>
    80004f86:	84aa                	mv	s1,a0
    80004f88:	c529                	beqz	a0,80004fd2 <create+0xee>
  ilock(ip);
    80004f8a:	ffffe097          	auipc	ra,0xffffe
    80004f8e:	628080e7          	jalr	1576(ra) # 800035b2 <ilock>
  ip->major = major;
    80004f92:	05549323          	sh	s5,70(s1)
  ip->minor = minor;
    80004f96:	05449423          	sh	s4,72(s1)
  ip->nlink = 1;
  ...
  iupdate(ip);
    ...
    80004fa6:	546080e7          	jalr	1350(ra) # 800034e8 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
    80004faa:	2981                	sext.w	s3,s3
    80004fac:	4785                	li	a5,1
    80004fae:	02f98a63          	beq	s3,a5,80004fe2 <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
    80004fb2:	40d0                	lw	a2,4(s1)
    80004fb4:	fb040593          	addi	a1,s0,-80
    80004fb8:	854a                	mv	a0,s2
    80004fba:	fffff097          	auipc	ra,0xfffff
    80004fbe:	cec080e7          	jalr	-788(ra) # 80003ca6 <dirlink>
    80004fc2:	06054b63          	bltz	a0,80005038 <create+0x154>
  iunlockput(dp);
    80004fc6:	854a                	mv	a0,s2
    80004fc8:	fffff097          	auipc	ra,0xfffff
    80004fcc:	84c080e7          	jalr	-1972(ra) # 80003814 <iunlockput>
  return ip;
    80004fd0:	b759                	j	80004f56 <create+0x72>
    panic("create: ialloc");
    80004fd2:	00003517          	auipc	a0,0x3
    80004fd6:	6fe50513          	addi	a0,a0,1790 # 800086d0 <syscalls+0x2a0>
    80004fda:	ffffb097          	auipc	ra,0xffffb
    80004fde:	556080e7          	jalr	1366(ra) # 80000530 <panic>
    dp->nlink++;  // for ".."
    80004fe2:	04a95783          	lhu	a5,74(s2)
    80004fe6:	2785                	addiw	a5,a5,1
    80004fe8:	04f91523          	sh	a5,74(s2)
    iupdate(dp);
    80004fec:	854a                	mv	a0,s2
    80004fee:	ffffe097          	auipc	ra,0xffffe
    80004ff2:	4fa080e7          	jalr	1274(ra) # 800034e8 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
    80004ff6:	40d0                	lw	a2,4(s1)
    80004ff8:	00003597          	auipc	a1,0x3
    80004ffc:	6e858593          	addi	a1,a1,1768 # 800086e0 <syscalls+0x2b0>
    80005000:	8526                	mv	a0,s1
    80005002:	fffff097          	auipc	ra,0xfffff
    80005006:	ca4080e7          	jalr	-860(ra) # 80003ca6 <dirlink>
    8000500a:	00054f63          	bltz	a0,80005028 <create+0x144>
    8000500e:	00492603          	lw	a2,4(s2)
    80005012:	00003597          	auipc	a1,0x3
    80005016:	6d658593          	addi	a1,a1,1750 # 800086e8 <syscalls+0x2b8>
    8000501a:	8526                	mv	a0,s1
    8000501c:	fffff097          	auipc	ra,0xfffff
    80005020:	c8a080e7          	jalr	-886(ra) # 80003ca6 <dirlink>
    80005024:	f80557e3          	bgez	a0,80004fb2 <create+0xce>
      panic("create dots");
    80005028:	00003517          	auipc	a0,0x3
    8000502c:	6c850513          	addi	a0,a0,1736 # 800086f0 <syscalls+0x2c0>
    80005030:	ffffb097          	auipc	ra,0xffffb
    80005034:	500080e7          	jalr	1280(ra) # 80000530 <panic>
    panic("create: dirlink");
    80005038:	00003517          	auipc	a0,0x3
    8000503c:	6c850513          	addi	a0,a0,1736 # 80008700 <syscalls+0x2d0>
    80005040:	ffffb097          	auipc	ra,0xffffb
    80005044:	4f0080e7          	jalr	1264(ra) # 80000530 <panic>
    return 0;
    80005048:	84aa                	mv	s1,a0
    8000504a:	b731                	j	80004f56 <create+0x72>

000000008000504c <sys_dup>:
{
  ...
  if(argfd(0, 0, &f) < 0)
    80005056:	fd840613          	addi	a2,s0,-40
    8000505a:	4581                	li	a1,0
    8000505c:	4501                	li	a0,0
    8000505e:	00000097          	auipc	ra,0x0
    80005062:	ddc080e7          	jalr	-548(ra) # 80004e3a <argfd>
    return -1;
    80005066:	57fd                	li	a5,-1
  if(argfd(0, 0, &f) < 0)
    80005068:	02054363          	bltz	a0,8000508e <sys_dup+0x42>
  if((fd=fdalloc(f)) < 0)
    8000506c:	fd843503          	ld	a0,-40(s0)
    80005070:	00000097          	auipc	ra,0x0
    80005074:	e32080e7          	jalr	-462(ra) # 80004ea2 <fdalloc>
    80005078:	84aa                	mv	s1,a0
    return -1;
    8000507a:	57fd                	li	a5,-1
  if((fd=fdalloc(f)) < 0)
    8000507c:	00054963          	bltz	a0,8000508e <sys_dup+0x42>
  filedup(f);
    80005080:	fd843503          	ld	a0,-40(s0)
    80005084:	fffff097          	auipc	ra,0xfffff
    80005088:	37a080e7          	jalr	890(ra) # 800043fe <filedup>
  return fd;
...
000000008000509a <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800050ae:	d90080e7          	jalr	-624(ra) # 80004e3a <argfd>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800050c2:	982080e7          	jalr	-1662(ra) # 80002a40 <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800050d6:	990080e7          	jalr	-1648(ra) # 80002a62 <argaddr>
    return -1;
  ...
  return fileread(f, p, n);
    ...
    800050f0:	49e080e7          	jalr	1182(ra) # 8000458a <fileread>
...
0000000080005100 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005114:	d2a080e7          	jalr	-726(ra) # 80004e3a <argfd>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005128:	91c080e7          	jalr	-1764(ra) # 80002a40 <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000513c:	92a080e7          	jalr	-1750(ra) # 80002a62 <argaddr>
    return -1;
  ...
  return filewrite(f, p, n);
    ...
    80005156:	4fa080e7          	jalr	1274(ra) # 8000464c <filewrite>
...
0000000080005166 <sys_close>:
{
  ...
  if(argfd(0, &fd, &f) < 0)
    ...
    8000517c:	cc2080e7          	jalr	-830(ra) # 80004e3a <argfd>
    return -1;
...
00000000800051b4 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    800051c8:	c76080e7          	jalr	-906(ra) # 80004e3a <argfd>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    800051dc:	88a080e7          	jalr	-1910(ra) # 80002a62 <argaddr>
    return -1;
  ...
  return filestat(f, st);
    ...
    800051f2:	32a080e7          	jalr	810(ra) # 80004518 <filestat>
...
0000000080005202 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    8000521c:	86c080e7          	jalr	-1940(ra) # 80002a84 <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    80005234:	854080e7          	jalr	-1964(ra) # 80002a84 <argstr>
    return -1;
  ...
  return 0;
    ...
    800052f2:	526080e7          	jalr	1318(ra) # 80003814 <iunlockput>
    end_op();
    800052f6:	fffff097          	auipc	ra,0xfffff
    800052fa:	d0e080e7          	jalr	-754(ra) # 80004004 <end_op>
    return -1;
    ...
    80005308:	510080e7          	jalr	1296(ra) # 80003814 <iunlockput>
  ilock(ip);
    8000530c:	8526                	mv	a0,s1
    8000530e:	ffffe097          	auipc	ra,0xffffe
    80005312:	2a4080e7          	jalr	676(ra) # 800035b2 <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80005326:	1c6080e7          	jalr	454(ra) # 800034e8 <iupdate>
  iunlockput(ip);
    8000532a:	8526                	mv	a0,s1
    8000532c:	ffffe097          	auipc	ra,0xffffe
    80005330:	4e8080e7          	jalr	1256(ra) # 80003814 <iunlockput>
  end_op();
    80005334:	fffff097          	auipc	ra,0xfffff
    80005338:	cd0080e7          	jalr	-816(ra) # 80004004 <end_op>
  return -1;
...
000000008000534c <sys_unlink>:
{
  ...
  memset(&de, 0, sizeof(de));
    ...
    80005402:	8d4080e7          	jalr	-1836(ra) # 80000cd2 <memset>
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80005418:	54a080e7          	jalr	1354(ra) # 8000395e <writei>
  ...
  iunlockput(dp);
    ...
    80005432:	3e6080e7          	jalr	998(ra) # 80003814 <iunlockput>
  ip->nlink--;
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    8000549c:	3ce080e7          	jalr	974(ra) # 80003866 <readi>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800054bc:	27050513          	addi	a0,a0,624 # 80008728 <syscalls+0x2f8>
    800054c0:	ffffb097          	auipc	ra,0xffffb
    800054c4:	070080e7          	jalr	112(ra) # 80000530 <panic>
    panic("unlink: writei");
    800054c8:	00003517          	auipc	a0,0x3
    800054cc:	27850513          	addi	a0,a0,632 # 80008740 <syscalls+0x310>
    800054d0:	ffffb097          	auipc	ra,0xffffb
    800054d4:	060080e7          	jalr	96(ra) # 80000530 <panic>
    dp->nlink--;
    ...
    800054e8:	004080e7          	jalr	4(ra) # 800034e8 <iupdate>
    ...
    800054f8:	320080e7          	jalr	800(ra) # 80003814 <iunlockput>
  iunlockput(dp);
    800054fc:	8526                	mv	a0,s1
    800054fe:	ffffe097          	auipc	ra,0xffffe
    80005502:	316080e7          	jalr	790(ra) # 80003814 <iunlockput>
  end_op();
    80005506:	fffff097          	auipc	ra,0xfffff
    8000550a:	afe080e7          	jalr	-1282(ra) # 80004004 <end_op>
  return -1;
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    8000553a:	54e080e7          	jalr	1358(ra) # 80002a84 <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    8000554e:	4f6080e7          	jalr	1270(ra) # 80002a40 <argint>
    80005552:	0a054863          	bltz	a0,80005602 <sys_open+0xe4>

  begin_op();
    80005556:	fffff097          	auipc	ra,0xfffff
    8000555a:	a2e080e7          	jalr	-1490(ra) # 80003f84 <begin_op>
  ...
  if(omode & O_CREATE){
    ...
    80005576:	972080e7          	jalr	-1678(ra) # 80004ee4 <create>
  ...
  iunlock(ip);
    ...
    800055f6:	082080e7          	jalr	130(ra) # 80003674 <iunlock>
  end_op();
    800055fa:	fffff097          	auipc	ra,0xfffff
    800055fe:	a0a080e7          	jalr	-1526(ra) # 80004004 <end_op>
  ...
  return fd;
    ...
    8000564a:	1ce080e7          	jalr	462(ra) # 80003814 <iunlockput>
      end_op();
    8000564e:	fffff097          	auipc	ra,0xfffff
    80005652:	9b6080e7          	jalr	-1610(ra) # 80004004 <end_op>
      return -1;
    80005656:	54fd                	li	s1,-1
    80005658:	b76d                	j	80005602 <sys_open+0xe4>
      end_op();
    8000565a:	fffff097          	auipc	ra,0xfffff
    8000565e:	9aa080e7          	jalr	-1622(ra) # 80004004 <end_op>
      return -1;
    ...
    8000566c:	1ac080e7          	jalr	428(ra) # 80003814 <iunlockput>
    end_op();
    80005670:	fffff097          	auipc	ra,0xfffff
    80005674:	994080e7          	jalr	-1644(ra) # 80004004 <end_op>
    return -1;
    ...
    80005690:	034080e7          	jalr	52(ra) # 800036c0 <itrunc>
    80005694:	bfb1                	j	800055f0 <sys_open+0xd2>
      fileclose(f);
    80005696:	854e                	mv	a0,s3
    80005698:	fffff097          	auipc	ra,0xfffff
    8000569c:	db8080e7          	jalr	-584(ra) # 80004450 <fileclose>
    iunlockput(ip);
    800056a0:	854a                	mv	a0,s2
    800056a2:	ffffe097          	auipc	ra,0xffffe
    800056a6:	172080e7          	jalr	370(ra) # 80003814 <iunlockput>
    end_op();
    800056aa:	fffff097          	auipc	ra,0xfffff
    800056ae:	95a080e7          	jalr	-1702(ra) # 80004004 <end_op>
    return -1;
...
sys_mkdir(void)
{
  ...
  begin_op();
    ...
    800056c2:	8c6080e7          	jalr	-1850(ra) # 80003f84 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    800056d4:	3b4080e7          	jalr	948(ra) # 80002a84 <argstr>
    ...
    800056ea:	7fe080e7          	jalr	2046(ra) # 80004ee4 <create>
  ...
  iunlockput(ip);
    ...
    800056f4:	124080e7          	jalr	292(ra) # 80003814 <iunlockput>
  end_op();
    800056f8:	fffff097          	auipc	ra,0xfffff
    800056fc:	90c080e7          	jalr	-1780(ra) # 80004004 <end_op>
  return 0;
    ...
    8000570e:	8fa080e7          	jalr	-1798(ra) # 80004004 <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005746:	2fe080e7          	jalr	766(ra) # 80002a40 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    80005758:	2ec080e7          	jalr	748(ra) # 80002a40 <argint>
     argint(1, &major) < 0 ||
    ...
    80005772:	776080e7          	jalr	1910(ra) # 80004ee4 <create>
     argint(2, &minor) < 0 ||
  ...
  iunlockput(ip);
    ...
    8000577c:	09c080e7          	jalr	156(ra) # 80003814 <iunlockput>
  end_op();
    80005780:	fffff097          	auipc	ra,0xfffff
    80005784:	884080e7          	jalr	-1916(ra) # 80004004 <end_op>
  return 0;
    80005788:	4501                	li	a0,0
    8000578a:	a031                	j	80005796 <sys_mknod+0x80>
    end_op();
    8000578c:	fffff097          	auipc	ra,0xfffff
    80005790:	878080e7          	jalr	-1928(ra) # 80004004 <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    800057ae:	1ea080e7          	jalr	490(ra) # 80001994 <myproc>
    800057b2:	892a                	mv	s2,a0
  
  begin_op();
    800057b4:	ffffe097          	auipc	ra,0xffffe
    800057b8:	7d0080e7          	jalr	2000(ra) # 80003f84 <begin_op>
  ...
  ilock(ip);
    ...
    800057e6:	dd0080e7          	jalr	-560(ra) # 800035b2 <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    800057fa:	e7e080e7          	jalr	-386(ra) # 80003674 <iunlock>
  iput(p->cwd);
    800057fe:	15093503          	ld	a0,336(s2)
    80005802:	ffffe097          	auipc	ra,0xffffe
    80005806:	f6a080e7          	jalr	-150(ra) # 8000376c <iput>
  end_op();
    8000580a:	ffffe097          	auipc	ra,0xffffe
    8000580e:	7fa080e7          	jalr	2042(ra) # 80004004 <end_op>
  p->cwd = ip;
  ...
  return 0;
    ...
    80005828:	7e0080e7          	jalr	2016(ra) # 80004004 <end_op>
    return -1;
    ...
    80005836:	fe2080e7          	jalr	-30(ra) # 80003814 <iunlockput>
    end_op();
    8000583a:	ffffe097          	auipc	ra,0xffffe
    8000583e:	7ca080e7          	jalr	1994(ra) # 80004004 <end_op>
    return -1;
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005866:	222080e7          	jalr	546(ra) # 80002a84 <argstr>
    return -1;
    8000586a:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    8000586c:	0c054a63          	bltz	a0,80005940 <sys_exec+0xfa>
    80005870:	e3840593          	addi	a1,s0,-456
    80005874:	4505                	li	a0,1
    80005876:	ffffd097          	auipc	ra,0xffffd
    8000587a:	1ec080e7          	jalr	492(ra) # 80002a62 <argaddr>
    8000587e:	0c054163          	bltz	a0,80005940 <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    ...
    80005890:	446080e7          	jalr	1094(ra) # 80000cd2 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
  ...
  memset(argv, 0, sizeof(argv));
    ...
    800058b6:	0f4080e7          	jalr	244(ra) # 800029a6 <fetchaddr>
    ...
    800058c8:	222080e7          	jalr	546(ra) # 80000ae6 <kalloc>
    ...
    800058de:	11e080e7          	jalr	286(ra) # 800029f8 <fetchstr>
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800058ee:	10048913          	addi	s2,s1,256
    800058f2:	6088                	ld	a0,0(s1)
    800058f4:	c529                	beqz	a0,8000593e <sys_exec+0xf8>
    kfree(argv[i]);
    800058f6:	ffffb097          	auipc	ra,0xffffb
    800058fa:	0f4080e7          	jalr	244(ra) # 800009ea <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    800058fe:	04a1                	addi	s1,s1,8
    80005900:	ff2499e3          	bne	s1,s2,800058f2 <sys_exec+0xac>
  return -1;
    80005904:	597d                	li	s2,-1
    80005906:	a82d                	j	80005940 <sys_exec+0xfa>
      argv[i] = 0;
    80005908:	0a8e                	slli	s5,s5,0x3
    8000590a:	fc040793          	addi	a5,s0,-64
    8000590e:	9abe                	add	s5,s5,a5
    80005910:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80005914:	e4040593          	addi	a1,s0,-448
    80005918:	f4040513          	addi	a0,s0,-192
    8000591c:	fffff097          	auipc	ra,0xfffff
    80005920:	194080e7          	jalr	404(ra) # 80004ab0 <exec>
    80005924:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005926:	10048993          	addi	s3,s1,256
    8000592a:	6088                	ld	a0,0(s1)
    8000592c:	c911                	beqz	a0,80005940 <sys_exec+0xfa>
    kfree(argv[i]);
    8000592e:	ffffb097          	auipc	ra,0xffffb
    80005932:	0bc080e7          	jalr	188(ra) # 800009ea <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005936:	04a1                	addi	s1,s1,8
    80005938:	ff3499e3          	bne	s1,s3,8000592a <sys_exec+0xe4>
    8000593c:	a011                	j	80005940 <sys_exec+0xfa>
  return -1;
    8000593e:	597d                	li	s2,-1
}
    80005940:	854a                	mv	a0,s2
    80005942:	60be                	ld	ra,456(sp)
    80005944:	641e                	ld	s0,448(sp)
    80005946:	74fa                	ld	s1,440(sp)
    80005948:	795a                	ld	s2,432(sp)
    8000594a:	79ba                	ld	s3,424(sp)
    8000594c:	7a1a                	ld	s4,416(sp)
    8000594e:	6afa                	ld	s5,408(sp)
    80005950:	6179                	addi	sp,sp,464
    80005952:	8082                	ret

0000000080005954 <sys_pipe>:

uint64
sys_pipe(void)
{
    80005954:	7139                	addi	sp,sp,-64
    80005956:	fc06                	sd	ra,56(sp)
    80005958:	f822                	sd	s0,48(sp)
    8000595a:	f426                	sd	s1,40(sp)
    8000595c:	0080                	addi	s0,sp,64
  uint64 fdarray; // user pointer to array of two integers
  struct file *rf, *wf;
  int fd0, fd1;
  struct proc *p = myproc();
    8000595e:	ffffc097          	auipc	ra,0xffffc
    80005962:	036080e7          	jalr	54(ra) # 80001994 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005972:	0f4080e7          	jalr	244(ra) # 80002a62 <argaddr>
    return -1;
    80005976:	57fd                	li	a5,-1
  if(argaddr(0, &fdarray) < 0)
    80005978:	0e054063          	bltz	a0,80005a58 <sys_pipe+0x104>
  if(pipealloc(&rf, &wf) < 0)
    8000597c:	fc840593          	addi	a1,s0,-56
    80005980:	fd040513          	addi	a0,s0,-48
    80005984:	fffff097          	auipc	ra,0xfffff
    80005988:	dfc080e7          	jalr	-516(ra) # 80004780 <pipealloc>
    return -1;
    8000598c:	57fd                	li	a5,-1
  if(pipealloc(&rf, &wf) < 0)
    8000598e:	0c054563          	bltz	a0,80005a58 <sys_pipe+0x104>
  fd0 = -1;
    80005992:	fcf42223          	sw	a5,-60(s0)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    80005996:	fd043503          	ld	a0,-48(s0)
    8000599a:	fffff097          	auipc	ra,0xfffff
    8000599e:	508080e7          	jalr	1288(ra) # 80004ea2 <fdalloc>
    800059a2:	fca42223          	sw	a0,-60(s0)
    800059a6:	08054c63          	bltz	a0,80005a3e <sys_pipe+0xea>
    800059aa:	fc843503          	ld	a0,-56(s0)
    800059ae:	fffff097          	auipc	ra,0xfffff
    800059b2:	4f4080e7          	jalr	1268(ra) # 80004ea2 <fdalloc>
    800059b6:	fca42023          	sw	a0,-64(s0)
    800059ba:	06054863          	bltz	a0,80005a2a <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    800059be:	4691                	li	a3,4
    800059c0:	fc440613          	addi	a2,s0,-60
    800059c4:	fd843583          	ld	a1,-40(s0)
    800059c8:	68a8                	ld	a0,80(s1)
    800059ca:	ffffc097          	auipc	ra,0xffffc
    800059ce:	c8c080e7          	jalr	-884(ra) # 80001656 <copyout>
    800059d2:	02054063          	bltz	a0,800059f2 <sys_pipe+0x9e>
     copyout(p->pagetable, fdarray+sizeof(fd0), (char *)&fd1, sizeof(fd1)) < 0){
    800059d6:	4691                	li	a3,4
    800059d8:	fc040613          	addi	a2,s0,-64
    800059dc:	fd843583          	ld	a1,-40(s0)
    800059e0:	0591                	addi	a1,a1,4
    800059e2:	68a8                	ld	a0,80(s1)
    800059e4:	ffffc097          	auipc	ra,0xffffc
    800059e8:	c72080e7          	jalr	-910(ra) # 80001656 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    800059ee:	06055563          	bgez	a0,80005a58 <sys_pipe+0x104>
    p->ofile[fd0] = 0;
    800059f2:	fc442783          	lw	a5,-60(s0)
    800059f6:	07e9                	addi	a5,a5,26
    800059f8:	078e                	slli	a5,a5,0x3
    800059fa:	97a6                	add	a5,a5,s1
    800059fc:	0007b023          	sd	zero,0(a5)
    p->ofile[fd1] = 0;
    80005a00:	fc042503          	lw	a0,-64(s0)
    80005a04:	0569                	addi	a0,a0,26
    80005a06:	050e                	slli	a0,a0,0x3
    80005a08:	9526                	add	a0,a0,s1
    80005a0a:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005a0e:	fd043503          	ld	a0,-48(s0)
    80005a12:	fffff097          	auipc	ra,0xfffff
    80005a16:	a3e080e7          	jalr	-1474(ra) # 80004450 <fileclose>
    fileclose(wf);
    80005a1a:	fc843503          	ld	a0,-56(s0)
    80005a1e:	fffff097          	auipc	ra,0xfffff
    80005a22:	a32080e7          	jalr	-1486(ra) # 80004450 <fileclose>
    return -1;
    80005a26:	57fd                	li	a5,-1
    80005a28:	a805                	j	80005a58 <sys_pipe+0x104>
    if(fd0 >= 0)
    80005a2a:	fc442783          	lw	a5,-60(s0)
    80005a2e:	0007c863          	bltz	a5,80005a3e <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80005a32:	01a78513          	addi	a0,a5,26
    80005a36:	050e                	slli	a0,a0,0x3
    80005a38:	9526                	add	a0,a0,s1
    80005a3a:	00053023          	sd	zero,0(a0)
    fileclose(rf);
    80005a3e:	fd043503          	ld	a0,-48(s0)
    80005a42:	fffff097          	auipc	ra,0xfffff
    80005a46:	a0e080e7          	jalr	-1522(ra) # 80004450 <fileclose>
    fileclose(wf);
    80005a4a:	fc843503          	ld	a0,-56(s0)
    80005a4e:	fffff097          	auipc	ra,0xfffff
    80005a52:	a02080e7          	jalr	-1534(ra) # 80004450 <fileclose>
    return -1;
    80005a56:	57fd                	li	a5,-1
}
    80005a58:	853e                	mv	a0,a5
    80005a5a:	70e2                	ld	ra,56(sp)
    80005a5c:	7442                	ld	s0,48(sp)
    80005a5e:	74a2                	ld	s1,40(sp)
    80005a60:	6121                	addi	sp,sp,64
    80005a62:	8082                	ret
	...
...
0000000080005a70 <kernelvec>:
    ...
    80005ab0:	dc3fc0ef          	jal	ra,80002872 <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    80005b4c:	e20080e7          	jalr	-480(ra) # 80001968 <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    80005b84:	de8080e7          	jalr	-536(ra) # 80001968 <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    80005bac:	dc0080e7          	jalr	-576(ra) # 80001968 <cpuid>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005c36:	5aa080e7          	jalr	1450(ra) # 800021dc <wakeup>
}
...
0000000080005c62 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005c80:	eca080e7          	jalr	-310(ra) # 80000b46 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
  ...
  memset(disk.pages, 0, sizeof(disk.pages));
    ...
    80005d18:	fbe080e7          	jalr	-66(ra) # 80000cd2 <memset>
...
{
    80005da6:	7159                	addi	sp,sp,-112
    80005da8:	f486                	sd	ra,104(sp)
    80005daa:	f0a2                	sd	s0,96(sp)
    80005dac:	eca6                	sd	s1,88(sp)
    80005dae:	e8ca                	sd	s2,80(sp)
    80005db0:	e4ce                	sd	s3,72(sp)
    80005db2:	e0d2                	sd	s4,64(sp)
    80005db4:	fc56                	sd	s5,56(sp)
    80005db6:	f85a                	sd	s6,48(sp)
    80005db8:	f45e                	sd	s7,40(sp)
    80005dba:	f062                	sd	s8,32(sp)
    80005dbc:	ec66                	sd	s9,24(sp)
    80005dbe:	e86a                	sd	s10,16(sp)
    80005dc0:	1880                	addi	s0,sp,112
    80005dc2:	892a                	mv	s2,a0
    80005dc4:	8d2e                	mv	s10,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    80005dc6:	00c52c83          	lw	s9,12(a0)
    80005dca:	001c9c9b          	slliw	s9,s9,0x1
    80005dce:	1c82                	slli	s9,s9,0x20
    80005dd0:	020cdc93          	srli	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    80005dd4:	0001f517          	auipc	a0,0x1f
    80005dd8:	35450513          	addi	a0,a0,852 # 80025128 <disk+0x2128>
    80005ddc:	ffffb097          	auipc	ra,0xffffb
    80005de0:	dfa080e7          	jalr	-518(ra) # 80000bd6 <acquire>
  for(int i = 0; i < 3; i++){
    80005de4:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    80005de6:	4c21                	li	s8,8
      disk.free[i] = 0;
    80005de8:	0001db97          	auipc	s7,0x1d
    80005dec:	218b8b93          	addi	s7,s7,536 # 80023000 <disk>
    80005df0:	6b09                	lui	s6,0x2
  for(int i = 0; i < 3; i++){
    80005df2:	4a8d                	li	s5,3
  for(int i = 0; i < NUM; i++){
    80005df4:	8a4e                	mv	s4,s3
    80005df6:	a051                	j	80005e7a <virtio_disk_rw+0xd4>
      disk.free[i] = 0;
    80005df8:	00fb86b3          	add	a3,s7,a5
    80005dfc:	96da                	add	a3,a3,s6
    80005dfe:	00068c23          	sb	zero,24(a3)
    idx[i] = alloc_desc();
    80005e02:	c21c                	sw	a5,0(a2)
    if(idx[i] < 0){
    80005e04:	0207c563          	bltz	a5,80005e2e <virtio_disk_rw+0x88>
  for(int i = 0; i < 3; i++){
    80005e08:	2485                	addiw	s1,s1,1
    80005e0a:	0711                	addi	a4,a4,4
    80005e0c:	25548063          	beq	s1,s5,8000604c <virtio_disk_rw+0x2a6>
    idx[i] = alloc_desc();
    80005e10:	863a                	mv	a2,a4
  for(int i = 0; i < NUM; i++){
    80005e12:	0001f697          	auipc	a3,0x1f
    80005e16:	20668693          	addi	a3,a3,518 # 80025018 <disk+0x2018>
    80005e1a:	87d2                	mv	a5,s4
    if(disk.free[i]){
    80005e1c:	0006c583          	lbu	a1,0(a3)
    80005e20:	fde1                	bnez	a1,80005df8 <virtio_disk_rw+0x52>
  for(int i = 0; i < NUM; i++){
    80005e22:	2785                	addiw	a5,a5,1
    80005e24:	0685                	addi	a3,a3,1
    80005e26:	ff879be3          	bne	a5,s8,80005e1c <virtio_disk_rw+0x76>
    idx[i] = alloc_desc();
    80005e2a:	57fd                	li	a5,-1
    80005e2c:	c21c                	sw	a5,0(a2)
      for(int j = 0; j < i; j++)
    80005e2e:	02905a63          	blez	s1,80005e62 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005e32:	f9042503          	lw	a0,-112(s0)
    80005e36:	00000097          	auipc	ra,0x0
    80005e3a:	d90080e7          	jalr	-624(ra) # 80005bc6 <free_desc>
      for(int j = 0; j < i; j++)
    80005e3e:	4785                	li	a5,1
    80005e40:	0297d163          	bge	a5,s1,80005e62 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005e44:	f9442503          	lw	a0,-108(s0)
    80005e48:	00000097          	auipc	ra,0x0
    80005e4c:	d7e080e7          	jalr	-642(ra) # 80005bc6 <free_desc>
      for(int j = 0; j < i; j++)
    80005e50:	4789                	li	a5,2
    80005e52:	0097d863          	bge	a5,s1,80005e62 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005e56:	f9842503          	lw	a0,-104(s0)
    80005e5a:	00000097          	auipc	ra,0x0
    80005e5e:	d6c080e7          	jalr	-660(ra) # 80005bc6 <free_desc>
  int idx[3];
  while(1){
    ...
    80005e62:	0001f597          	auipc	a1,0x1f
    80005e66:	2c658593          	addi	a1,a1,710 # 80025128 <disk+0x2128>
    80005e6a:	0001f517          	auipc	a0,0x1f
    80005e6e:	1ae50513          	addi	a0,a0,430 # 80025018 <disk+0x2018>
    80005e72:	ffffc097          	auipc	ra,0xffffc
    80005e76:	1de080e7          	jalr	478(ra) # 80002050 <sleep>
  for(int i = 0; i < 3; i++){
    80005e7a:	f9040713          	addi	a4,s0,-112
    80005e7e:	84ce                	mv	s1,s3
    80005e80:	bf41                	j	80005e10 <virtio_disk_rw+0x6a>
  ...
  if(write)
    ...
    80005e82:	20058713          	addi	a4,a1,512
    80005e86:	00471693          	slli	a3,a4,0x4
    80005e8a:	0001d717          	auipc	a4,0x1d
    80005e8e:	17670713          	addi	a4,a4,374 # 80023000 <disk>
    80005e92:	9736                	add	a4,a4,a3
    80005e94:	4685                	li	a3,1
    80005e96:	0ad72423          	sw	a3,168(a4)
  else
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
  buf0->reserved = 0;
    80005e9a:	20058713          	addi	a4,a1,512
    80005e9e:	00471693          	slli	a3,a4,0x4
    80005ea2:	0001d717          	auipc	a4,0x1d
    80005ea6:	15e70713          	addi	a4,a4,350 # 80023000 <disk>
    80005eaa:	9736                	add	a4,a4,a3
    80005eac:	0a072623          	sw	zero,172(a4)
  buf0->sector = sector;
    80005eb0:	0b973823          	sd	s9,176(a4)

  disk.desc[idx[0]].addr = (uint64) buf0;
    80005eb4:	7679                	lui	a2,0xffffe
    80005eb6:	963e                	add	a2,a2,a5
    80005eb8:	0001f697          	auipc	a3,0x1f
    80005ebc:	14868693          	addi	a3,a3,328 # 80025000 <disk+0x2000>
    80005ec0:	6298                	ld	a4,0(a3)
    80005ec2:	9732                	add	a4,a4,a2
    80005ec4:	e308                	sd	a0,0(a4)
  disk.desc[idx[0]].len = sizeof(struct virtio_blk_req);
    80005ec6:	6298                	ld	a4,0(a3)
    80005ec8:	9732                	add	a4,a4,a2
    80005eca:	4541                	li	a0,16
    80005ecc:	c708                	sw	a0,8(a4)
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    80005ece:	6298                	ld	a4,0(a3)
    80005ed0:	9732                	add	a4,a4,a2
    80005ed2:	4505                	li	a0,1
    80005ed4:	00a71623          	sh	a0,12(a4)
  disk.desc[idx[0]].next = idx[1];
    80005ed8:	f9442703          	lw	a4,-108(s0)
    80005edc:	6288                	ld	a0,0(a3)
    80005ede:	962a                	add	a2,a2,a0
    80005ee0:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffd800e>

  disk.desc[idx[1]].addr = (uint64) b->data;
    80005ee4:	0712                	slli	a4,a4,0x4
    80005ee6:	6290                	ld	a2,0(a3)
    80005ee8:	963a                	add	a2,a2,a4
    80005eea:	05890513          	addi	a0,s2,88
    80005eee:	e208                	sd	a0,0(a2)
  disk.desc[idx[1]].len = BSIZE;
    80005ef0:	6294                	ld	a3,0(a3)
    80005ef2:	96ba                	add	a3,a3,a4
    80005ef4:	40000613          	li	a2,1024
    80005ef8:	c690                	sw	a2,8(a3)
  if(write)
    80005efa:	140d0063          	beqz	s10,8000603a <virtio_disk_rw+0x294>
    disk.desc[idx[1]].flags = 0; // device reads b->data
    80005efe:	0001f697          	auipc	a3,0x1f
    80005f02:	1026b683          	ld	a3,258(a3) # 80025000 <disk+0x2000>
    80005f06:	96ba                	add	a3,a3,a4
    80005f08:	00069623          	sh	zero,12(a3)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    80005f0c:	0001d817          	auipc	a6,0x1d
    80005f10:	0f480813          	addi	a6,a6,244 # 80023000 <disk>
    80005f14:	0001f517          	auipc	a0,0x1f
    80005f18:	0ec50513          	addi	a0,a0,236 # 80025000 <disk+0x2000>
    80005f1c:	6114                	ld	a3,0(a0)
    80005f1e:	96ba                	add	a3,a3,a4
    80005f20:	00c6d603          	lhu	a2,12(a3)
    80005f24:	00166613          	ori	a2,a2,1
    80005f28:	00c69623          	sh	a2,12(a3)
  disk.desc[idx[1]].next = idx[2];
    80005f2c:	f9842683          	lw	a3,-104(s0)
    80005f30:	6110                	ld	a2,0(a0)
    80005f32:	9732                	add	a4,a4,a2
    80005f34:	00d71723          	sh	a3,14(a4)

  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    80005f38:	20058613          	addi	a2,a1,512
    80005f3c:	0612                	slli	a2,a2,0x4
    80005f3e:	9642                	add	a2,a2,a6
    80005f40:	577d                	li	a4,-1
    80005f42:	02e60823          	sb	a4,48(a2)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    80005f46:	00469713          	slli	a4,a3,0x4
    80005f4a:	6114                	ld	a3,0(a0)
    80005f4c:	96ba                	add	a3,a3,a4
    80005f4e:	03078793          	addi	a5,a5,48
    80005f52:	97c2                	add	a5,a5,a6
    80005f54:	e29c                	sd	a5,0(a3)
  disk.desc[idx[2]].len = 1;
    80005f56:	611c                	ld	a5,0(a0)
    80005f58:	97ba                	add	a5,a5,a4
    80005f5a:	4685                	li	a3,1
    80005f5c:	c794                	sw	a3,8(a5)
  disk.desc[idx[2]].flags = VRING_DESC_F_WRITE; // device writes the status
    80005f5e:	611c                	ld	a5,0(a0)
    80005f60:	97ba                	add	a5,a5,a4
    80005f62:	4809                	li	a6,2
    80005f64:	01079623          	sh	a6,12(a5)
  disk.desc[idx[2]].next = 0;
    80005f68:	611c                	ld	a5,0(a0)
    80005f6a:	973e                	add	a4,a4,a5
    80005f6c:	00071723          	sh	zero,14(a4)

  // record struct buf for virtio_disk_intr().
  b->disk = 1;
    80005f70:	00d92223          	sw	a3,4(s2)
  disk.info[idx[0]].b = b;
    80005f74:	03263423          	sd	s2,40(a2)

  // tell the device the first index in our chain of descriptors.
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    80005f78:	6518                	ld	a4,8(a0)
    80005f7a:	00275783          	lhu	a5,2(a4)
    80005f7e:	8b9d                	andi	a5,a5,7
    80005f80:	0786                	slli	a5,a5,0x1
    80005f82:	97ba                	add	a5,a5,a4
    80005f84:	00b79223          	sh	a1,4(a5)

  __sync_synchronize();
    80005f88:	0ff0000f          	fence

  // tell the device another avail ring entry is available.
  disk.avail->idx += 1; // not % NUM ...
    80005f8c:	6518                	ld	a4,8(a0)
    80005f8e:	00275783          	lhu	a5,2(a4)
    80005f92:	2785                	addiw	a5,a5,1
    80005f94:	00f71123          	sh	a5,2(a4)
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
    ...
    80005fa0:	0407a823          	sw	zero,80(a5) # 10001050 <_entry-0x6fffefb0>

  // Wait for virtio_disk_intr() to say request has finished.
  while(b->disk == 1) {
    80005fa4:	00492703          	lw	a4,4(s2)
    80005fa8:	4785                	li	a5,1
    80005faa:	02f71163          	bne	a4,a5,80005fcc <virtio_disk_rw+0x226>
    sleep(b, &disk.vdisk_lock);
    80005fae:	0001f997          	auipc	s3,0x1f
    80005fb2:	17a98993          	addi	s3,s3,378 # 80025128 <disk+0x2128>
  while(b->disk == 1) {
    80005fb6:	4485                	li	s1,1
    sleep(b, &disk.vdisk_lock);
    80005fb8:	85ce                	mv	a1,s3
    80005fba:	854a                	mv	a0,s2
    80005fbc:	ffffc097          	auipc	ra,0xffffc
    80005fc0:	094080e7          	jalr	148(ra) # 80002050 <sleep>
  while(b->disk == 1) {
    80005fc4:	00492783          	lw	a5,4(s2)
    80005fc8:	fe9788e3          	beq	a5,s1,80005fb8 <virtio_disk_rw+0x212>
  }

  disk.info[idx[0]].b = 0;
    80005fcc:	f9042903          	lw	s2,-112(s0)
    80005fd0:	20090793          	addi	a5,s2,512
    80005fd4:	00479713          	slli	a4,a5,0x4
    80005fd8:	0001d797          	auipc	a5,0x1d
    80005fdc:	02878793          	addi	a5,a5,40 # 80023000 <disk>
    80005fe0:	97ba                	add	a5,a5,a4
    80005fe2:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    80005fe6:	0001f997          	auipc	s3,0x1f
    80005fea:	01a98993          	addi	s3,s3,26 # 80025000 <disk+0x2000>
    80005fee:	00491713          	slli	a4,s2,0x4
    80005ff2:	0009b783          	ld	a5,0(s3)
    80005ff6:	97ba                	add	a5,a5,a4
    80005ff8:	00c7d483          	lhu	s1,12(a5)
    int nxt = disk.desc[i].next;
    80005ffc:	854a                	mv	a0,s2
    80005ffe:	00e7d903          	lhu	s2,14(a5)
    free_desc(i);
    80006002:	00000097          	auipc	ra,0x0
    80006006:	bc4080e7          	jalr	-1084(ra) # 80005bc6 <free_desc>
    if(flag & VRING_DESC_F_NEXT)
    8000600a:	8885                	andi	s1,s1,1
    8000600c:	f0ed                	bnez	s1,80005fee <virtio_disk_rw+0x248>
  free_chain(idx[0]);

  release(&disk.vdisk_lock);
    8000600e:	0001f517          	auipc	a0,0x1f
    80006012:	11a50513          	addi	a0,a0,282 # 80025128 <disk+0x2128>
    80006016:	ffffb097          	auipc	ra,0xffffb
    8000601a:	c74080e7          	jalr	-908(ra) # 80000c8a <release>
}
    8000601e:	70a6                	ld	ra,104(sp)
    80006020:	7406                	ld	s0,96(sp)
    80006022:	64e6                	ld	s1,88(sp)
    80006024:	6946                	ld	s2,80(sp)
    80006026:	69a6                	ld	s3,72(sp)
    80006028:	6a06                	ld	s4,64(sp)
    8000602a:	7ae2                	ld	s5,56(sp)
    8000602c:	7b42                	ld	s6,48(sp)
    8000602e:	7ba2                	ld	s7,40(sp)
    80006030:	7c02                	ld	s8,32(sp)
    80006032:	6ce2                	ld	s9,24(sp)
    80006034:	6d42                	ld	s10,16(sp)
    80006036:	6165                	addi	sp,sp,112
    80006038:	8082                	ret
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    8000603a:	0001f697          	auipc	a3,0x1f
    8000603e:	fc66b683          	ld	a3,-58(a3) # 80025000 <disk+0x2000>
    80006042:	96ba                	add	a3,a3,a4
    80006044:	4609                	li	a2,2
    80006046:	00c69623          	sh	a2,12(a3)
    8000604a:	b5c9                	j	80005f0c <virtio_disk_rw+0x166>
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    8000604c:	f9042583          	lw	a1,-112(s0)
    80006050:	20058793          	addi	a5,a1,512
    80006054:	0792                	slli	a5,a5,0x4
    80006056:	0001d517          	auipc	a0,0x1d
    8000605a:	05250513          	addi	a0,a0,82 # 800230a8 <disk+0xa8>
    8000605e:	953e                	add	a0,a0,a5
  if(write)
    80006060:	e20d11e3          	bnez	s10,80005e82 <virtio_disk_rw+0xdc>
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
    80006064:	20058713          	addi	a4,a1,512
    80006068:	00471693          	slli	a3,a4,0x4
    8000606c:	0001d717          	auipc	a4,0x1d
    80006070:	f9470713          	addi	a4,a4,-108 # 80023000 <disk>
    80006074:	9736                	add	a4,a4,a3
    80006076:	0a072423          	sw	zero,168(a4)
    8000607a:	b505                	j	80005e9a <virtio_disk_rw+0xf4>

000000008000607c <virtio_disk_intr>:
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80006094:	b46080e7          	jalr	-1210(ra) # 80000bd6 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
    80006098:	10001737          	lui	a4,0x10001
    8000609c:	533c                	lw	a5,96(a4)
    8000609e:	8b8d                	andi	a5,a5,3
    800060a0:	d37c                	sw	a5,100(a4)
  ...
  while(disk.used_idx != disk.used->idx){
    800060a6:	0001f797          	auipc	a5,0x1f
    800060aa:	f5a78793          	addi	a5,a5,-166 # 80025000 <disk+0x2000>
    800060ae:	6b94                	ld	a3,16(a5)
    800060b0:	0207d703          	lhu	a4,32(a5)
    800060b4:	0026d783          	lhu	a5,2(a3)
    800060b8:	06f70163          	beq	a4,a5,8000611a <virtio_disk_intr+0x9e>
    __sync_synchronize();
    ...
    int id = disk.used->ring[disk.used_idx % NUM].id;
    800060d0:	6898                	ld	a4,16(s1)
    800060d2:	0204d783          	lhu	a5,32(s1)
    800060d6:	8b9d                	andi	a5,a5,7
    800060d8:	078e                	slli	a5,a5,0x3
    800060da:	97ba                	add	a5,a5,a4
    800060dc:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    800060de:	20078713          	addi	a4,a5,512
    800060e2:	0712                	slli	a4,a4,0x4
    800060e4:	974a                	add	a4,a4,s2
    800060e6:	03074703          	lbu	a4,48(a4) # 10001030 <_entry-0x6fffefd0>
    800060ea:	e731                	bnez	a4,80006136 <virtio_disk_intr+0xba>
      panic("virtio_disk_intr status");

    struct buf *b = disk.info[id].b;
    800060ec:	20078793          	addi	a5,a5,512
    800060f0:	0792                	slli	a5,a5,0x4
    800060f2:	97ca                	add	a5,a5,s2
    800060f4:	7788                	ld	a0,40(a5)
    b->disk = 0;   // disk is done with buf
    800060f6:	00052223          	sw	zero,4(a0)
    wakeup(b);
    800060fa:	ffffc097          	auipc	ra,0xffffc
    800060fe:	0e2080e7          	jalr	226(ra) # 800021dc <wakeup>

    disk.used_idx += 1;
    80006102:	0204d783          	lhu	a5,32(s1)
    80006106:	2785                	addiw	a5,a5,1
    80006108:	17c2                	slli	a5,a5,0x30
    8000610a:	93c1                	srli	a5,a5,0x30
    8000610c:	02f49023          	sh	a5,32(s1)
  while(disk.used_idx != disk.used->idx){
    80006110:	6898                	ld	a4,16(s1)
    80006112:	00275703          	lhu	a4,2(a4)
    80006116:	faf71be3          	bne	a4,a5,800060cc <virtio_disk_intr+0x50>
  }
  ...
  release(&disk.vdisk_lock);
    ...
    80006126:	b68080e7          	jalr	-1176(ra) # 80000c8a <release>
}
    ...
    8000613a:	6aa50513          	addi	a0,a0,1706 # 800087e0 <syscalls+0x3b0>
    8000613e:	ffffa097          	auipc	ra,0xffffa
    80006142:	3f2080e7          	jalr	1010(ra) # 80000530 <panic>
	...
